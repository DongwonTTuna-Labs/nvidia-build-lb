...
HEALTHCHECK --interval=2s --timeout=2s --start-period=10s --retries=10 \
  CMD ["/usr/bin/setpriv", "--reuid=65532", "--regid=65532", "--clear-groups", "--inh-caps=-all", "--ambient-caps=-all", "--bounding-set=-all", "--no-new-privs", "/usr/local/bin/nblb-healthcheck", "65532", "65532", "app"]
