...
- Automation is exact Python `playwright==1.61.0` using Playwright-managed Chromium revision 1228 from `/home/dongwonttuna/.cache/ms-playwright`. It never uses an alternate browser index, channel, executable override, system fallback, or install/download during normal tests. A missing revision-1228 managed cache is a blocking failure.
